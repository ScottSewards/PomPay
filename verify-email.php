...
if (isset($SubmitButton)) {
	...
	if ($SubmitCode==$emailCode) {
		...
		$WrongCodeError = "Wrong code. Please try again.";
	}
}
?>
<?php
...
<main>
	<section>
		...
		<p>Check your email address inbox for an email with an email verification code. Enter the code below to verify your email address. If you cannot see the email, check your junk folder or if you have not recieved the email, <a href="#">resend the email verification.</a></p>
	</section>
	...
	<section>
		...
		<p><a href='support.php'>Having trouble? Contact us on the support page</a></p>
	</section>
</main>
